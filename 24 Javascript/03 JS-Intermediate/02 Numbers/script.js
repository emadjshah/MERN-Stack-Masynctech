...
//Converting User Input to Integer - Number.parseInt() Method
const userInput = '42'
...
//Converting Price for an E-commerce Checkout - Number.parseFloat() Method
...
//Calculating Grade Point Average (GPA) - Number.isNaN() Method
const inputGPA ="3.8";
...
// console.log(newSavings); or the below one:
...
/* Validating User Input for Discount Calculation
 ...
 const discountRate = parseFloat(prompt('Enter the discount rate'))
 let discountPrice;
    */

/* if(isFinite(originalPrice) && isFinite(discountRate)){
...
//Math.abs() Method
//----
>>>>>>> 8708d6b6436c4c926cafd0f1463e10bc0c381447
